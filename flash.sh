...
FIRMWARE="$1" #1st argument -> path to .bin file (e.g ./amm-tiny.bin)
MNTPOINT="$2" #2nd argument -> specify a mount point for the device (e.g /mnt/ammdk created) with 'sudo mkdir /mnt/ammdk 
